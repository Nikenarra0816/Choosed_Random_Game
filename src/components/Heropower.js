...
export class Heropower extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
          data: {},
      ...
      async componentDidMount() {
        ...
        let heroPower =  value.Basic.filter(function(v) {
            return v.type == 'Hero Power';
        })
        this.setState({isLoading: false, data: heroPower})
