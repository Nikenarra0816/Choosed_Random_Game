...
export class Enchantment extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
          data: {},
      ...
      async componentDidMount() {
        ...
        let enchantment =  value.Basic.filter(function(v) {
            return v.type == 'Enchantment';
        })
        this.setState({isLoading: false, data: enchantment})
